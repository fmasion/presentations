...
/** @constructor */
var $c_Lexample_Demo2$ = (function() {
  $c_O.call(this)
});
$c_Lexample_Demo2$.prototype = new $h_O();
$c_Lexample_Demo2$.prototype.constructor = $c_Lexample_Demo2$;
/** @constructor */
var $h_Lexample_Demo2$ = (function() {
  /*<skip>*/
});
$h_Lexample_Demo2$.prototype = $c_Lexample_Demo2$.prototype;
$c_Lexample_Demo2$.prototype.$$js$exported$meth$run__O = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = this$2.outVar$2;
  $as_Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V("Hello from DEMO2")
});
$c_Lexample_Demo2$.prototype["run"] = (function() {
  return this.$$js$exported$meth$run__O()
});
var $d_Lexample_Demo2$ = new $ClassTypeData({
  Lexample_Demo2$: 0
}, false, "example.Demo2$", {
  Lexample_Demo2$: 1,
  O: 1
});
$c_Lexample_Demo2$.prototype.$classData = $d_Lexample_Demo2$;
var $n_Lexample_Demo2$ = (void 0);
var $m_Lexample_Demo2$ = (function() {
  if ((!$n_Lexample_Demo2$)) {
    $n_Lexample_Demo2$ = new $c_Lexample_Demo2$().init___()
  };
  return $n_Lexample_Demo2$
});
$e["example"] = ($e["example"] || {});
$e["example"]["Demo2"] = $m_Lexample_Demo2$;
/** @constructor */
...
/** @constructor */
var $c_Lexample_HelloConsole$ = (function() {
  $c_O.call(this)
});
$c_Lexample_HelloConsole$.prototype = new $h_O();
$c_Lexample_HelloConsole$.prototype.constructor = $c_Lexample_HelloConsole$;
/** @constructor */
var $h_Lexample_HelloConsole$ = (function() {
  /*<skip>*/
});
$h_Lexample_HelloConsole$.prototype = $c_Lexample_HelloConsole$.prototype;
$c_Lexample_HelloConsole$.prototype.init___ = (function() {
  $n_Lexample_HelloConsole$ = this;
  return this
});
$c_Lexample_HelloConsole$.prototype.main__V = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = this$2.outVar$2;
  $as_Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V("Hello from SCALA-JS");
  var div = $m_s_Option$().apply__O__s_Option($g["document"]["getElementById"]("toto"));
  var x = ("Div : " + div);
  var this$5 = $m_s_Console$();
  var this$6 = this$5.outVar$2;
  $as_Ljava_io_PrintStream(this$6.tl$1.get__O()).println__O__V(x);
  var divTest = $g["document"]["getElementById"]("test");
  var x$1 = ("Div test : " + $as_T(divTest["innerHTML"]));
  var this$8 = $m_s_Console$();
  var this$9 = this$8.outVar$2;
  $as_Ljava_io_PrintStream(this$9.tl$1.get__O()).println__O__V(x$1);
  var this$10 = $m_s_Option$().apply__O__s_Option($g["document"]["getElementById"]("notExist"));
  if (this$10.isEmpty__Z()) {
    var newStyle = $g["document"]["createElement"]("style");
    newStyle["id"] = "notExist";
    $g["document"]["head"]["appendChild"](newStyle);
    var stylesheet = newStyle
  } else {
    var stylesheet = this$10.get__O()
  };
  var x$2 = ("creation d'une feuille de style " + stylesheet);
  var this$12 = $m_s_Console$();
  var this$13 = this$12.outVar$2;
  $as_Ljava_io_PrintStream(this$13.tl$1.get__O()).println__O__V(x$2)
});
$c_Lexample_HelloConsole$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lexample_HelloConsole$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lexample_HelloConsole$ = new $ClassTypeData({
  Lexample_HelloConsole$: 0
}, false, "example.HelloConsole$", {
  Lexample_HelloConsole$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lexample_HelloConsole$.prototype.$classData = $d_Lexample_HelloConsole$;
var $n_Lexample_HelloConsole$ = (void 0);
var $m_Lexample_HelloConsole$ = (function() {
  if ((!$n_Lexample_HelloConsole$)) {
    $n_Lexample_HelloConsole$ = new $c_Lexample_HelloConsole$().init___()
  };
  return $n_Lexample_HelloConsole$
});
$e["example"] = ($e["example"] || {});
$e["example"]["HelloConsole"] = $m_Lexample_HelloConsole$;
